...
void inventory(sf::RenderWindow& win)
{
    ...
    sf::Font font;
    font.loadFromFile("/Users/admin/Downloads/�®¢ ï ¯ ¯ª /image/FontOver.otf");
    sf::Text Tcash;
    Tcash.setFont(font);
    ...
    ifstream inv; string path_inv = "/Users/admin/Desktop/KseniaDino/KseniaDino/inventory.txt"; string Sinv;
